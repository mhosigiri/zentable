...
function PureSuggestedActions({
  ...
  const suggestedActions = customActions || defaultSuggestedActions;

  return (
    <div
      data-testid="suggested-actions"
      className="grid grid-cols-1 sm:grid-cols-2 pb-2 gap-2 w-full"
    >
      <AnimatePresence>
...
const SuggestedActions = memo(
  ...
  (prevProps, nextProps) => {
    ...
    if (prevProps.selectedVisibilityType !== nextProps.selectedVisibilityType)
      return false;
    if (!equal(prevProps.customActions, nextProps.customActions)) return false;
    return true;
  },
);
       ...
       {showSuggestedActions && (
         ...
         >
            <SuggestedActions
              ...
              customActions={customSuggestedActions}
            />
         </motion.div>
       )}
      </AnimatePresence>
